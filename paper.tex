...
In case of SC(5,3) and SC(4,3), the centrality dependence is weaker than the other harmonic correlations and a monotonic increase is observed.
In case of NSC($m$,$n$), NSC(5,3) shows the strongest centrality dependence and NSC(4,2), NSC(5,2) shows a weak centrality dependence.
Both NSC(3,2) and NSC(4,3) show a monotonic increase toward peripheral collisions with similar magnitude.
...
%which is strikingly different from $p_{\rm T}$ dependence of individual flow harmonics, which is nearly flat (see Fig. 3 in Ref.~\cite{Abelev:2012di}).
