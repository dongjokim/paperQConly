...
To obtain the $p_{\rm T}$ dependence of SC$(m,n)$ results, we apply minimum $p_{\rm T}$ cuts, instead of $p_{\rm T}$ bin-by-bin interval in order to avoid large statistical fluctuations in the results. The various minimum $p_{\rm T}$ cuts from 0.2 to 1.5 GeV$/c$ are applied.
