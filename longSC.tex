...
The default configuration of the AMPT model gives the best $\chi^{2}_{ndf}$ values for NSC($m$,$n$), especially for NSC(3,2). However the $\chi^{2}_{ndf}$ values of this model are largest for $v_n$ among the models especially for $v_2$.
