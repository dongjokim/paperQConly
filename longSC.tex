...
\begin{figure*}[!]
            \begin{center}
                       ...
                       \resizebox{0.32\textwidth}{!}{\includegraphics{figs/fig_SC_hydro_42.eps}}
              \end{center}
        \caption{Results of  SC(5,2), SC(5,3) and SC(4,3) in $\PbPb$ collisions at $\snn=2.76$~TeV are compared to hydrodynamic calculations. The dashed lines are hydrodynamic predictions with various $\eta/s(T)$ parameterizations~\cite{Niemi:2015qia}. These SC(3,2) and SC(4,2) will be replaced with new figures for higher order correlations once we have the calculations from Harri Niemi et. al~\cite{Niemi:2015qia}.}
        \label{fig:Figure_5}
\end{figure*}
