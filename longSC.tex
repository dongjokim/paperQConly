...
\begin{figure*}
	\begin{center}
        ...
        \caption{The individual flow harmonics $v_n$ (n=2, 3, 4 and 5) in $\PbPb$ collisions at $\snn=2.76$~TeV are shown on the left panels. The $p_{\rm T}$  dependence of $v_n$ (n=2, 3 and 4) is shown on the right panels. }
        \label{fig:Figure_2A}
        \end{center}   
\end{figure*}
