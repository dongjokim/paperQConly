...
These $p_{\rm T, min}$ dependent correlations have much stronger centrality dependence, with SC$(m,n)$ getting much larger as the centrality or $p_{\rm T, min}$ increase. 
...
It can be seen in Fig.~\ref{fig:Figure_2} that for NSC(3,2) there is no $p_{\rm T}$ dependence in the centrality range $<$30\%, and a moderate decreasing trend with increasing $p_{\rm T}$ is observed in the $>$30\% centrality range.
NSC(4,2) shows a moderate decreasing trend as $p_{\rm T}$ or centrality increases. 
