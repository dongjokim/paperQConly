...
There is experimental and theoretical evidence~\cite{Alver:2010gr,Qiu:2011iv,ALICE:2011ab} that the lower order harmonics, $v_2$ and $v_3$, are to a good approximation linearly proportional to the deformations in the initial energy density in the transverse plane (e.g. $v_n \propto \varepsilon_n$ for $n~=~$2 or 3).
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.51\textwidth}{!}{\includegraphics{figs/fig2_QConly_higherSC.eps}}\hspace{-0.67cm}
                       \resizebox{0.51\textwidth}{!}{\includegraphics{figs/fig2_QConly_higherNSC.eps}}
