...
Anisotropic flow~\cite{Ollitrault:1992bk} is nowadays quantified with $n^{\mathrm{th}}$-order flow coefficients $v_n$ and corresponding symmetry plane angles $\Psi_n$ in a Fourier decomposition of the particle azimuthal distribution in the plane transverse to the beam direction~\cite{Voloshin:1994mz,Poskanzer:1998yz}:
...
The first results for a new multiparticle observables which quantify the relationship between event-by-event fluctuations of two different flow harmonics, the so-called Symmetric 2-harmonic 4-particle Cumulants (SC), were recently reported by the ALICE Collaboration~\cite{ALICE:2016kpq}.
...
\begin{figure*}
	\begin{center}
        	\resizebox{0.92\columnwidth}{!}{\includegraphics{figs/fig4_QConly_ptdep_All.eps}}
...
To study the $p_{\rm T}$ dependence of SC$(m,n)$, we gradually change the low $p_{\rm T}$ cut-off ($p_{\rm T, min}$), instead of using independent $p_{\rm T}$ intervals, in order to avoid large statistical fluctuations in the results. Various minimum $p_{\rm T}$ cuts from 0.2 to 1.5~GeV/$c$ are applied.
...
SC($m$,$n$) and NSC($m$,$n$) are compared to several theoretical calculations. The event-by-event EKRT+viscous hydrodynamic predictions with the different parameterizations for the temperature dependence of the shear viscosity to entropy density ratio $\eta/s(T)$ are shown in Fig.~2 of Ref.~\cite{ALICE:2016kpq}. 
...
%SC($m$,$n$) and NSC($m$,$n$) for $m$+$n$$<$7
While we discussed the comparison to these hydrodynamic model calculations with various temperature dependent $\eta/s$ parameterizations, only two calculations with the parameters which describe the lower order harmonic correlations best are compared to the results in Fig.~\ref{fig:Figure_3}. 
...
\begin{figure*}[!]
            \begin{center}
                       \resizebox{\multfigsize\textwidth}{!}{\includegraphics{figs/ModelComparison_All_EKRT.eps}}
              \end{center}
...
Similar to the event-by-event EKRT+viscous hydrodynamic calculations~\cite{Niemi:2015qia}, the sign of the normalized NSC(3,2) in the model calculations in Fig.~\ref{fig:Figure_4} is opposite to that in data in 0--10\% central collisions. NSC(3,2) does not show sensitivity to the initial conditions nor to the different $\eta/s$ parameterizations used in the models and cannot be described quantitatively by these models.
...
\begin{figure*}[!]
	\begin{center}
        	\resizebox{\multfigsize\columnwidth}{!}{\includegraphics{figs/ModelComparison_All_VISH.eps}}
...
% \end{figure*}
 ...
 \begin{figure*}[!]
	\begin{center}
        	\resizebox{\multfigsize\columnwidth}{!}{\includegraphics{figs/ModelComparison_All_AMPT.eps}}
...
SC($m$,$n$) and NSC($m$,$n$) calculated from AMPT simulations are compared with data in Fig.~\ref{fig:Figure_5}.
...
NSC(3,2) and NSC(4,2) as a function of $p_{\rm T, min}$ are compared to the {AMPT} simulations in Fig.~\ref{fig:Figure_6} and Fig.~\ref{fig:Figure_7}, respectively.
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/hydrocom_v2.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/hydrocom_v3.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/hydrocom_v4.eps}}
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/vishcom_v2.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/vishcom_v3.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/vishcom_v4.eps}}
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/amptcom_v2.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/amptcom_v3.eps}}
                       \resizebox{0.31\textwidth}{!}{\includegraphics{figs/amptcom_v4.eps}}
