...
These products are obtained from two-particle correlations using a pseudorapidity gap of $|\Delta\eta| > 1.0$. We use the notation $v_n$ instead of $v_{n}\{2, |\Delta\eta|>1\}$ used in \cite{Adam:2016izf} and they are $p_{\rm T}$ integrated.
