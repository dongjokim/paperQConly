...
\begin{figure*}[h]
	\begin{center}
        	\resizebox{0.42\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC32_vish.eps}}
        	\resizebox{0.42\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC42_vish.eps}}
...
\begin{figure*}[!]
	\begin{center}
        	\resizebox{0.42\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC32_ampt.eps}}
        	\resizebox{0.42\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC42_ampt.eps}}
        \caption{SC(3,2) (a) and SC(4,2) (b) are compared to various AMPT models. Upper panels (lower) are the results of SC$(m,n)$ (NSC$(m,n)$).}
        \label{fig:Figure_4}
        \end{center}   
 \end{figure*}
...
The event-by-event EKRT+viscous hydrodynamic predictions with the different parameterizations for the temperature dependence of the shear viscosity to entropy density ratio $\eta/s(T)$ are shown on the left in Fig.~\ref{fig:Figure_5}. 
...
\begin{figure*}[!]
 ...
 \begin{figure*}[h]
	\begin{center}
        ...
        \caption{Results of  SC(5,2), SC(5,3) and SC(4,3) are compared to various AMPT models. Upper panels are the results of SC$(m,n)$ and the lower panels are the results of NSC$(m,n)$.}
        \label{fig:Figure_7}
        \end{center}   
 \end{figure*}
...
\begin{figure}[p]
             \begin{center}
              ...
              \end{center}
             \caption{NSC(3,2) (Top) and NSC(4,2) (Bottom) as a function of minimum $p_{\rm T}$ cuts are compared to various AMPT models.}
             \label{fig:Figure_8}
\end{figure}
