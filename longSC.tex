...
Detector inefficiencies were introduced to mimic the non-uniform azimuthal distribution in the data. For the observables SC(5,2), SC(5,3), and SC(4,3), the variation due to nonuniform acceptance is about 9\%, 17\%, and 11\%, respectively.
...
\begin{figure*}[t!]
            \begin{center}
                       \resizebox{0.51\textwidth}{!}{\includegraphics{figs/Fig1a_higherSC}}\hspace{-0.67cm}
                       \resizebox{0.51\textwidth}{!}{\includegraphics{figs/Fig1b_higherNSC}}
...
\begin{figure}[t!]
	\begin{center}
        	\resizebox{0.92\columnwidth}{!}{\includegraphics{figs/Fig2_pt_SC_NSC}}
...
To study the $p_{\rm T}$ dependence of SC$(m,n)$, we present the results as a function of the low $p_{\rm T}$ cutoff ($p_{\rm T, min}$), instead of using independent $p_{\rm T}$ intervals; this decreases large statistical fluctuations in the results. Various minimum $p_{\rm T}$ cuts from 0.2 to 1.5~GeV/$c$ are applied.
...
\begin{figure}[t!]
	\begin{center}
        	\resizebox{0.92\columnwidth}{!}{\includegraphics{figs/Fig3_vn_xpt}}
...
\begin{figure}[t!]
            \begin{center}
                       \resizebox{\multfigsize\textwidth}{!}{\includegraphics{figs/Fig4_ModelComparison_EKRT}}
              \end{center}
...
\begin{figure}[t!]
	\begin{center}
        	\resizebox{\multfigsize\columnwidth}{!}{\includegraphics{figs/Fig5_ModelComparison_VISH}}
...
The SC(4,3) results clearly favor smaller $\eta/s$ values but NSC(4,3) cannot be described by these models quantitively.
 ...
 \begin{figure}[t!]
	\begin{center}
        	\resizebox{\multfigsize\columnwidth}{!}{\includegraphics{figs/Fig6_ModelComparison_AMPT}}
...
\begin{figure}[t!]
            \begin{center}
                       \resizebox{0.99\textwidth}{!}{\includegraphics{figs/Fig7_chisqndf_bestfits_3pad}}
...
\begin{figure}[t!]
             \begin{center}
              \resizebox{0.95\textwidth}{!}{\includegraphics{figs/Fig8_pt_NSC32_Models}}
              \end{center}
...
\begin{figure}[t!]
             \begin{center}
              \resizebox{0.95\textwidth}{!}{\includegraphics{figs/Fig9_pt_NSC42_Models}}
              \end{center}
...
The event-by-event EKRT+viscous hydrodynamic calculations are also compared to the data in Figs.~\ref{fig:Figure_8} and \ref{fig:Figure_9}.
