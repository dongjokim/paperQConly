...
\section{Results}
\label{sec:results}
The centrality dependence of the higher order harmonic correlations (SC($m$,$n$) for $m$+$n$ $>$ 6) are presented in Fig.~\ref{fig:Figure_1} and compared to the lower order harmonic correlations (SC($m$,$n$) for $m$+$n$ $\leq$ 6) which were measured in \cite{ALICE:2016kpq}. The correlation between $v_3$ and $v_4$ is negative, and similarly for $v_3$ and $v_2$, while the other correlations are all positive, which reveals that $v_2$ and $v_5$ as well as $v_3$ and $v_5$ are correlated like $v_2$ and $v_4$, while $v_3$ and $v_4$ are anti-correlated like $v_3$ and $v_2$.
...
\begin{figure*}
	\begin{center}
        ...
        \caption{The individual flow harmonics $v_n$ (n=2, 3, 4 and 5) in $\PbPb$ collisions at $\snn=2.76$~TeV are shown on the left panels ((A), (B) and (C)). The $p_{\rm T, min}$ dependence of $v_n$ (n=2, 3 and 4) is shown on the right panels ((a), (b) and (c)). Note that $v_5$ is shown in the panel (C) with $v_4$.}
        \label{fig:Figure_2A}
        \end{center}   
\end{figure*}
...
The complete sets of the individual flow harmonics $v_n$ used to calculate the NSC observables are shown in Fig.~\ref{fig:Figure_2A}. The centrality dependence of $v_n$ (n=2, 3, 4 and 5) is shown in the left panels ((A), (B) and (C)) of  Fig.~\ref{fig:Figure_2A}. The results of $v_n$ (n $<$ 5) are equivalent to those in \cite{Adam:2016izf}. The fifth order flow harmonics $v_5$ is shown on the panel (C) as an new addition in this article. The $p_{\rm T, min}$ dependence of $v_n$ (n=2, 3 and 4) is shown in the right panels ((a), (b) and (c)) of Fig.~\ref{fig:Figure_2A} in all centrality ranges relevant to the measured NSC($m$,$n$) observables.
