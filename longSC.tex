...
As shown in Fig.~\ref{fig:Figure_5}, the correlations between $v_5$ and $v_2$ and between $v_5$ and $v_3$ are well described by those two model parameters within errors.  The model calculations for SC(5,2) and SC(5,3) give better description than the correlations between $v_4$ and $v_2$. 
