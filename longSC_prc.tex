...
\end{equation}
where the curly brackets denote the average over the transverse plane, i.e., $\{\cdots\}$ = $\int dxdy$\, $e(x,y,\tau_0)$ $(\cdots)$, $r$ is the distance to the system's center of mass from nucleon position, $e(x,y,\tau_0)$ is the energy density at the initial time $\tau_0$, and $\Phi_{n}$ is the participant plane angle (see Ref.~\cite{Teaney:2010vd,Niemi:2015qia}).
...
To obtain the $p_{\rm T}$ dependence of SC$(m,n)$ results, we vary minimum $p_{\rm T}$ cuts, instead of $p_{\rm T}$ bin-by-bin interval, in order to avoid large statistical fluctuations in the results. Various minimum $p_{\rm T}$ cuts from 0.2 to 1.5~GeV/$c$ are applied.
...
\begin{figure*}[hpt]
	\begin{center}
        	\resizebox{0.9\columnwidth}{!}{\includegraphics{figs/fig4_QConly_SC_ptdep}}
        	\resizebox{0.9\columnwidth}{!}{\includegraphics{figs/fig4_QConly_nSC_ptdep}}
	\resizebox{0.9\columnwidth}{!}{\includegraphics{figs/fig4b_QConly_SC_ptdep}}
        	\resizebox{0.9\columnwidth}{!}{\includegraphics{figs/fig4b_QConly_nSC_ptdep}}
...
\begin{figure*}
	\begin{center}
        	\resizebox{0.85\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC32_vish.eps}}
        	\resizebox{0.85\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC42_vish.eps}}
...
\begin{figure*}[!]
	\begin{center}
        	\resizebox{0.85\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC32_ampt.eps}}
        	\resizebox{0.85\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC42_ampt.eps}}
...
\begin{figure*}[!]
	\begin{center}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC52_vish.eps}}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC53_vish.eps}}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC43_vish.eps}}
...
\end{widetext} %PRC
 ...
 \begin{figure*}[h]
	\begin{center}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC52_ampt.eps}}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC53_ampt.eps}}
        	\resizebox{0.62\columnwidth}{!}{\includegraphics{figs/fig3_QConly_ModelComparison_SC43_ampt.eps}}
...
\begin{figure*}
             \begin{center}
              \resizebox{0.45\textwidth}{!}{\includegraphics{figs/fig5_QConly_xminpt_nSC32.eps}}
              \resizebox{0.45\textwidth}{!}{\includegraphics{figs/fig5_QConly_xminpt_nSC42.eps}}
              \end{center}
