...
The systematic uncertainty due to the track reconstruction was estimated using two additional tracking criteria, first relying on the so-called standalone TPC tracking with the 
...
\begin{figure}[htp]
\subfloat[SC($m$,$n$)]{\includegraphics[clip,width=\columnwidth]{figs/fig2_QConly_higherSC.eps}}\\
\subfloat[NSC($m$,$n$)]{\includegraphics[clip,width=\columnwidth]{figs/fig2_QConly_higherNSC.eps}}
%                       \resizebox{0.40\textwidth}{!}{\includegraphics{figs/fig2_QConly_higherSC.eps}}
%                       \resizebox{0.40\textwidth}{!}{\includegraphics{figs/fig2_QConly_higherNSC.eps}}
...
\begin{figure*}[htp]
\subfloat[SC($m$,$n$) for $p_{\rm T}<0.7$~GeV/$c$ ]{\includegraphics[clip,width=\columnwidth]{figs/fig4_QConly_SC_ptdep}}
\subfloat[NSC($m$,$n$) for $p_{\rm T}<0.7$~GeV/$c$]{\includegraphics[clip,width=\columnwidth]{figs/fig4_QConly_nSC_ptdep}}\\
\subfloat[SC($m$,$n$) for $0.8<p_{\rm T}$~GeV/$c$]{\includegraphics[clip,width=\columnwidth]{figs/fig4b_QConly_SC_ptdep}}
\subfloat[NSC($m$,$n$) $0.8<p_{\rm T}$~GeV/$c$]{\includegraphics[clip,width=\columnwidth]{figs/fig4b_QConly_SC_ptdep}}
...
\begin{widetext}
\begin{figure*}[htp]
\subfloat[SC(3,2) and NSC(3,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig3_QConly_ModelComparison_SC32_vish.eps}}
\subfloat[SC(4,2) and NSC(4,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig3_QConly_ModelComparison_SC42_vish.eps}}
...
Hence the use of SC$(m,n)$ and NSC$(m,n)$ can provide new constraints on the detailed modeling of the initial state conditions and the fluctuations of the medium created in heavy-ion collisions. The better constraints on the initial state conditions will certainly reduce the uncertainties of determining $\eta/s(T)$.
 ...
 \begin{figure*}[hpt]
\subfloat[SC(3,2) and NSC(3,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig3_QConly_ModelComparison_SC32_ampt.eps}}
\subfloat[SC(4,2) and NSC(4,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig3_QConly_ModelComparison_SC42_ampt.eps}}	
...
Finally, the extracted results for final state particles from AMPT simulations in the same way as for the data are compared in Fig.~\ref{fig:Figure_4}.
...
\begin{widetext}
\begin{figure*}[hpt]
\subfloat[SC($m$,$n$)]{\includegraphics[clip,width=\columnwidth]{figs/fig1_QConly_hydro.eps}}
\subfloat[NSC($m$,$n$)]{\includegraphics[clip,width=\columnwidth]{figs/fig1_QConly_hydro_norm.eps}}
...
\begin{figure*}[hpt]
\subfloat[SC(5,2) and NSC(5,2)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC52_vish.eps}}
\subfloat[SC(5,3) and NSC(5,3)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC53_vish.eps}}
\subfloat[SC(4,3) and NSC(4,3)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC43_vish.eps}}
...
\begin{widetext}
\begin{figure*}[!]
\subfloat[SC(5,2) and NSC(5,2)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC52_ampt.eps}}
\subfloat[SC(5,3) and NSC(5,3)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC53_ampt.eps}}
\subfloat[SC(4,3) and NSC(4,3)]{\includegraphics[clip,width=0.7\columnwidth]{figs/fig3_QConly_ModelComparison_SC43_ampt.eps}}
...
\begin{figure}[htp]
\subfloat[NSC(3,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig5_QConly_xminpt_nSC32.eps}}\\
\subfloat[NSC(4,2)]{\includegraphics[clip,width=\columnwidth]{figs/fig5_QConly_xminpt_nSC42.eps}}
