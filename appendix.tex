...
\begin{figure*}[h]
        ...
        \caption{The individual flow harmonics $v_n$ for $n$ = 2--4 in $\PbPb$ collisions at $\snn=2.76$~TeV~\cite{Adam:2016izf}. The results are compared with selected calculations from three different types of models which are best in describing $v_n$ coefficients.}
        \label{fig:Figure_A4}
              \end{center}
\end{figure*}
