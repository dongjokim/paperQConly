...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA1_v2_comp_EKRT}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA1_v3_comp_EKRT}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA1_v4_comp_EKRT}}
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA2_v2_comp_VISH}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA2_v3_comp_VISH}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA2_v4_comp_VISH}}
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA3_v2_comp_AMPT}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA3_v3_comp_AMPT}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA3_v4_comp_AMPT}}
...
\begin{figure*}[h]
            \begin{center}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA4_v2_modelcomparisonBest}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA4_v3_modelcomparisonBest}}\hspace{-0.27cm}
                       \resizebox{0.34\textwidth}{!}{\includegraphics{figs/FigA4_v4_modelcomparisonBest}}
